...
BEGIN
    ...
    UPDATEFIELD('VERSION', ASSETS[I].VERSION, ENTRY.VERSION);
...
BEGIN
    ...
    BEGIN
        ...
        (* WRITE META LINE *)
        WRITELN(F, '(* ', ASSETS[I].CNAME, ' AT: ', I, ' *)');
        (* WRITE ASSET DATA *)
        WRITELN(F, ASSETS[I].PATH);
        WRITELN(F, ASSETS[I].CNAME);
        WRITELN(F, ASSETS[I].VERSION);
